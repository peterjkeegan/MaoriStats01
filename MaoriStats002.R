### start - Maori Stats 2013  Peter J Keegan  29 Dec 2013 ####
#
library(ggplot2)
library(reshape2)
library(scales)
#
# Create vectors of NZ Census Data with addition of 2021 "guestimates"
#
...
Speakers <- c(NA, NA, 130485, 131601,125352,116000)
#
